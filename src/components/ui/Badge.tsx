...
export const Badge = React.forwardRef<HTMLSpanElement, BadgeProps>(
  ({ className, variant = 'clinical', ...props }, ref) => {
    const variants = {
      ...
      clinical: 'bg-emerald-50 text-[var(--color-thread-mid-green)] border border-emerald-100/30 text-[0.68rem] px-2.5 py-1 font-semibold',
      active: 'bg-[var(--color-thread-light-green)]/40 text-[var(--color-thread-mid-green)] border-transparent font-bold tracking-wide uppercase text-[0.74rem] px-3.5 py-1.5',
    };
